...
if __name__ == "__main__":
	...
	if resume:
		...
		model = PPO2.load("ppo2_swimmer", env = env, n_steps = 1000, verbose=1, tensorboard_log='./tf_logs/swimmer')
	else:
		print("not resuming")
		#two layers of size 64
		model = PPO2(MlpPolicy, env, n_steps = 1000, verbose=1, gamma = gamma, tensorboard_log='./tf_logs/swimmer')
