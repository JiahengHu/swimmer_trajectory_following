...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--maxtimesteps', type=int, default=int(1e6), help='max timesteps')
    ...
    parser.add_argument('--steps_before_robot_update',type=int, default=1e5, help='start updating the robot at this timestep.')
    parser.add_argument('--steps_after_robot_update',type=int, default=1e5, help='finetune the policy for this many timesteps after freezing the robot distribution.')
