...
if __name__ == "__main__":
	...
	model = PPO2.load("ppo2_swimmer_action_range_"+str(action_range), env = env, verbose=1, tensorboard_log='./tf_logs/test_action_range_continue/')
